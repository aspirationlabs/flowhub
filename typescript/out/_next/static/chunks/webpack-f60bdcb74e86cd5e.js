(() => {
  ...
  function s(e) {
    ...
    var r = (c[e] = { exports: {} }),
      o = !0;
    try {
      (l[e].call(r.exports, r, r.exports, s), (o = !1));
    } finally {
      o && delete c[e];
    }
    return r.exports;
  ...
  ((s.m = l),
    ...
    (s.O = (t, r, o, n) => {
      ...
      for (var a = 1 / 0, i = 0; i < e.length; i++) {
        for (var [r, o, n] = e[i], u = !0, l = 0; l < r.length; l++)
          (!1 & n || a >= n) && Object.keys(s.O).every((e) => s.O[e](r[l]))
            ? r.splice(l--, 1)
            : ((u = !1), n < a && (a = n));
        if (u) {
          e.splice(i--, 1);
    ...
    (s.t = function (e, o) {
      if (
        ...
        8 & o ||
          ('object' == typeof e &&
            e &&
            ((4 & o && e.__esModule) || (16 & o && 'function' == typeof e.then))))
      )
        return e;
    ...
    (s.l = (e, t, r, n) => {
      ...
      var d = (t, r) => {
        ...
        f = setTimeout(d.bind(null, void 0, { type: 'timeout', target: i }), 12e4);
